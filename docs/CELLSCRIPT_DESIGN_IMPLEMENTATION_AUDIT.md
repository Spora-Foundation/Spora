...
- `cellscript/src/` contains `40,424` lines of Rust across `26` source files.
- `cellscript/src/` plus `cellscript/tests/` contains `44,793` lines of Rust across `28` files.
