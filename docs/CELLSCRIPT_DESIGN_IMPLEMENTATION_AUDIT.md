...
- `cellscript/src/` contains `40,313` lines of Rust across `26` source files.
- `cellscript/src/` plus `cellscript/tests/` contains `44,682` lines of Rust across `28` files.
