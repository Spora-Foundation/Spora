...
- `cellscript/src/` contains `40,358` lines of Rust across `26` source files.
- `cellscript/src/` plus `cellscript/tests/` contains `44,727` lines of Rust across `28` files.
