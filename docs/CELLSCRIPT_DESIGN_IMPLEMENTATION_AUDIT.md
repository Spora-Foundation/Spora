...
- `cellscript/src/` contains `39,790` lines of Rust across `26` source files.
- `cellscript/src/` plus `cellscript/tests/` contains `44,159` lines of Rust across `28` files.
