...
| `consume` / `create` syntax | Real, with checked consume data-load metadata, checked/gap direct create output field/lock components, and partial executable checks | 70-80% |
