...
- `cellscript/src/` contains `40,498` lines of Rust across `26` source files.
- `cellscript/src/` plus `cellscript/tests/` contains `44,867` lines of Rust across `28` files.
