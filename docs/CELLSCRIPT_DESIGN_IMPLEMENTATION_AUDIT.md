...
| User-defined generics | Deliberately downgraded out of the v1 executable core; parser/type checker reject generic type definitions and user-defined instantiations. Post-v1 template/codegen may generate concrete specialized `.cell` modules; `Vec<T>` remains a controlled builtin collection notation | N/A for v1 core |
