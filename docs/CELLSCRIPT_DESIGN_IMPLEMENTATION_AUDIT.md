...
- `cellscript/src/` contains `40,259` lines of Rust across `26` source files.
- `cellscript/src/` plus `cellscript/tests/` contains `44,628` lines of Rust across `28` files.
