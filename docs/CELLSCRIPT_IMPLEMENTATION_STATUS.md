...
- Rust source size: `38,922` lines across `26` files under `cellscript/src/`; `43,291` lines across `28` Rust files when `cellscript/tests/` integration tests are included.
- Test inventory: `336` `#[test]` declarations are present in source/test files; the default-feature active suite run below executed `323` tests.
