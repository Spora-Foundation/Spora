...
- Rust source size: `39,023` lines across `26` files under `cellscript/src/`; `43,392` lines across `28` Rust files when `cellscript/tests/` integration tests are included.
