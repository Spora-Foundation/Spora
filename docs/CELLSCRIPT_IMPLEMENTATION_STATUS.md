...
- Rust source size: `39,323` lines across `26` files under `cellscript/src/`; `43,692` lines across `28` Rust files when `cellscript/tests/` integration tests are included.
- Test inventory: `341` `#[test]` declarations are present in source/test files; the default-feature active suite run below executed `328` tests.
