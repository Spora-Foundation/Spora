...
- Rust source size: `38,819` lines across `26` files under `cellscript/src/`; `43,188` lines across `28` Rust files when `cellscript/tests/` integration tests are included.
- Test inventory: `335` `#[test]` declarations are present in source/test files; the default-feature active suite run below executed `322` tests.
