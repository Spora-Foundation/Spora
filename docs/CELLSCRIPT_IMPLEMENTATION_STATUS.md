...
- Rust source size: `38,452` lines across `26` files under `cellscript/src/`; `42,821` lines across `28` Rust files when `cellscript/tests/` integration tests are included.
- Test inventory: `332` `#[test]` declarations are present in source/test files; the default-feature active suite run below executed `318` tests.
...
- `0` doctests
- total executed: `318` tests, `0` failures
