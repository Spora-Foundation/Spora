...
- Rust source size: `38,279` lines across `26` files under `cellscript/src/`; `42,648` lines across `28` Rust files when `cellscript/tests/` integration tests are included.
- Test inventory: `326` `#[test]` declarations are present in source/test files; the default-feature active suite run below executed `310` tests.
...
- `0` doctests
- total executed: `310` tests, `0` failures
