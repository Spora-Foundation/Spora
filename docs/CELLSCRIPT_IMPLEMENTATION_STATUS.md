...
- Rust source size: `38,690` lines across `26` files under `cellscript/src/`; `43,059` lines across `28` Rust files when `cellscript/tests/` integration tests are included.
- Test inventory: `334` `#[test]` declarations are present in source/test files; the default-feature active suite run below executed `321` tests.
