...
Like Tondid, the Rothschild window should remain open and undisturbed.
...
Like the Tondid and Rothschild windows, the miner window should also be left undisturbed, and closing it will stop the mining.
