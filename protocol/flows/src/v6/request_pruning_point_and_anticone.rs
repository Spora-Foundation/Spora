...
//! since the syncee no longer uses them in the rusty-tondi design where the full sub-DAG is sent
//!
...
use tondi_p2p_lib::{
    ...
    pb::{
        self, tondid_message::Payload, BlockWithTrustedDataV4Message, DoneBlocksWithTrustedDataMessage, PruningPointsMessage,
        TrustedDataMessage,
    },
