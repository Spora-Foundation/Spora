/*!
# Rusty Spora WASM32 bindings

[<img alt="github" src="https://img.shields.io/badge/github-sporanet/rusty--spora-8da0cb?style=for-the-badge&labelColor=555555&color=8da0cb&logo=github" height="20">](https://github.com/AvatoLabs/Spora/tree/master/wasm)
[<img alt="crates.io" src="https://img.shields.io/crates/v/spora-wasm.svg?maxAge=2592000&style=for-the-badge&color=fc8d62&logo=rust" height="20">](https://crates.io/crates/spora-wasm)
[<img alt="docs.rs" src="https://img.shields.io/badge/docs.rs-spora--wasm-56c2a5?maxAge=2592000&style=for-the-badge&logo=docs.rs" height="20">](https://docs.rs/spora-wasm)
<img alt="license" src="https://img.shields.io/crates/l/spora-wasm.svg?maxAge=2592000&color=6ac&style=for-the-badge&logoColor=fff" height="20">

<br>

spora WASM32 bindings offer direct integration of Rust code and spora
codebase within JavaScript environments such as Node.js and Web Browsers.

## Documentation

- [**Integrating with Spora** guide](https://spora.aspectron.org/)
- [Rust SDK documentation (**Rustdoc**)](https://docs.rs/spora-wasm/)
- [TypeScript documentation (**JSDoc**)](https://spora.aspectron.org/docs/)
...
- **RPC API** — [RPC interface bindings](spora_wrpc_wasm::client) for the Spora node using WebSocket (wRPC) connections.
...
- <https://www.npmjs.com/package/spora>
- <https://www.npmjs.com/package/spora-wasm>

The `spora-wasm` module is a pure WASM32 module that includes
the entire wallet framework, but does not support RPC due to an absence
of a native WebSocket in NodeJs environment, while
the `spora` module includes `websocket` package dependency simulating
...
<https://github.com/AvatoLabs/Spora/tree/master/wasm/nodejs>

## WASM32 Binaries

For pre-built browser-compatible WASM32 redistributables of this
framework please see the releases section of the Rusty Spora
repository at <https://github.com/AvatoLabs/Spora/releases>.

## Development Builds

The latest development builds from <https://spora.aspectron.org/nightly/downloads/>.
...
<https://aspectron.org/en/projects/spora-wasm.html>.
...
<html>
    <head>
        <script type="module">
            import * as spora_wasm from './spora/spora-wasm.js';
            (async () => {
                const spora = await spora_wasm.default('./spora/spora-wasm_bg.wasm');
                // ...
            })();
        </script>
    </head>
...
// this is provided by NPM `spora` module and is only needed
// if you are building WASM libraries for NodeJS from source
// globalThis.WebSocket = require('websocket').w3cwebsocket;

let {RpcClient,Encoding,initConsolePanicHook} = require('./spora-rpc');
...
For more details, please follow the [**Integrating with Spora**](https://spora.aspectron.org/) guide.
...
compile_error!("`spora-wasm` crate for WASM32 target must be built with `--features wasm32-sdk|wasm32-rpc|wasm32-core|wasm32-keygen`");
...
cfg_if::cfg_if! {
    ...
    if #[cfg(feature = "wasm32-sdk")] {
        ...
        pub mod rpc {
            ...
            pub mod messages {
                //! Spora RPC messages
                pub use spora_rpc_core::model::message::*;
            }
            pub use spora_rpc_core::api::rpc::RpcApi;
            pub use spora_rpc_core::wasm::message::*;

            pub use spora_wrpc_wasm::client::*;
            pub use spora_wrpc_wasm::resolver::*;
            pub use spora_wrpc_wasm::notify::*;
        }

        pub use spora_consensus_wasm::*;
        pub use spora_wallet_keys::prelude::*;
        pub use spora_wallet_core::wasm::*;
        ...
        pub use spora_wallet_keys::prelude::*;
        pub use spora_wallet_core::wasm::*;
        pub use spora_bip32::wasm::*;

    } else if #[cfg(feature = "wasm32-rpc")] {

        pub use spora_rpc_core::api::rpc::RpcApi;
        pub use spora_rpc_core::wasm::message::*;
        pub use spora_rpc_core::wasm::message::IPingRequest;
        pub use spora_wrpc_wasm::client::*;
        pub use spora_wrpc_wasm::resolver::*;
        pub use spora_wrpc_wasm::notify::*;
