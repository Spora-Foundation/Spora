...
## Sequential processing flow (in the previous Go implementation)

Below we detail the prior Go implementation and discuss future parallelism opportunities. Processing dependencies between various stages are detailed in square brackets [***deps; type***].
...
The current code design in the prior Go implementation already logically supported this since the various processing stages were already decoupled for supporting efficient IBD.
