    ...
    fn validate_body_in_isolation_test() {
        ...
        let example_block = MutableBlock::new(
            Header::new_finalized(
                ...
                Hash::from_slice(&[
                    0x04, 0xa0, 0x6c, 0x77, 0xe6, 0x8a, 0xb1, 0xb1, 0xd9, 0xde, 0xe5, 0xec, 0xd8, 0x83, 0x48, 0x78, 0x96, 0x01, 0x94, 0x14, 0x4e, 0x66, 0x03, 0xde, 0xfb, 0xea, 0x73, 0xf0, 0x40, 0x16, 0xfe, 0x5f,
                ]),
                Default::default(),
                Default::default(),
                0x17305aa654a,
