...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0x7e, 0x7b, 0x26, 0xff, 0xcf, 0x08, 0xe3, 0x92, 0x23, 0x52, 0x51, 0xae, 0x55, 0x1a, 0x95, 0x13, 0x89, 0x03, 0x35, 0x70, 0x35,
        0x71, 0x8d, 0x3b, 0x4c, 0xb4, 0x18, 0x85, 0x18, 0xcb, 0x2d, 0xdc,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
