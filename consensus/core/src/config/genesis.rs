...
pub const SIMNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0xb7, 0xfa, 0x13, 0x49, 0x87, 0xb5, 0x43, 0x2d, 0xd6, 0xd1, 0x48, 0x28, 0xb5, 0x63, 0x92, 0x57, 0xfe, 0x18, 0x4d, 0x03, 0x12,
        0x06, 0xed, 0x9c, 0x2c, 0x78, 0xab, 0x26, 0x1a, 0x82, 0x4b, 0x37,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
