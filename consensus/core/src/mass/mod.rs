...
pub struct UtxoCell {
    ...
    pub plurality: u64,
    /// The amount of TND (in sompis) locked in this UTXO
    pub amount: u64,
}
...
mod tests {
    use super::*;
    use crate::{
        constants::{SOMPI_PER_TONDI, STORAGE_MASS_PARAMETER},
        network::NetworkType,
        ...
        */
        let test_cases = vec![
            ...
            PluralityTestCase {
                ...
                outputs_tx2: &[200 * SOMPI_PER_TONDI, 400 * SOMPI_PER_TONDI],
                plurality_index: Some(1),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                ...
                inputs_tx2: &[1000 * SOMPI_PER_TONDI],
                outputs_tx2: &[400 * SOMPI_PER_TONDI],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                ...
                inputs_tx2: &[350 * SOMPI_PER_TONDI, 500 * SOMPI_PER_TONDI, 350 * SOMPI_PER_TONDI, 500 * SOMPI_PER_TONDI],
                outputs_tx2: &[200 * SOMPI_PER_TONDI, 200 * SOMPI_PER_TONDI, 400 * SOMPI_PER_TONDI, 750 * SOMPI_PER_TONDI],
    ...
    fn test_storage_mass() {
        ...
        let base_value = 10_000 * SOMPI_PER_TONDI;
        ...
        tx2.tx.outputs[0].value = 10 * SOMPI_PER_TONDI;
