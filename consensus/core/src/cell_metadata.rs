...
mod tests {
    ...
    fn test_cell_metadata_creation() {
        ...
        let meta = CellMeta {
            out_point: TransactionOutpoint { transaction_id: [0u8; 32].into(), index: 0 },
            capacity: 100_000,
            data_bytes: 100,
            lock_hash: [1u8; 32],
    ...
    fn test_roundtrip_conversion() {
        ...
        let meta = CellMeta {
            out_point: TransactionOutpoint { transaction_id: [5u8; 32].into(), index: 1 },
            capacity: 50_000,
            data_bytes: 50,
            lock_hash: [5u8; 32],
            type_hash: None,
    ...
    fn test_with_data() {
        ...
        let meta = CellMeta {
            out_point: TransactionOutpoint { transaction_id: [1u8; 32].into(), index: 0 },
            capacity: 100_000,
            data_bytes: 4,
            lock_hash: [1u8; 32],
            type_hash: None,
