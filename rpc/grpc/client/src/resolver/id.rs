use crate::{
    error::{Error, Result},
    resolver::{P2pMessageReceiver, P2pMessageSender, Resolver},
};
...
impl Pending {
    fn new(sender: P2pMessageSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: RpcPayloadOps, request: &RpcRequest) -> P2pMessageReceiver {
