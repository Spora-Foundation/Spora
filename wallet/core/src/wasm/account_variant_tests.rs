...
async fn test_wasm_wallet_initialization() {
    ...
    let wallet_config = js_object_with(&[
        ("resident", JsValue::from_bool(true)),
        ("networkId", JsValue::from_str("testnet-11")),
    ]);
...
async fn test_wasm_watch_only_account_e2e() {
    ...
    let name = Reflect::get(&account_config, &JsValue::from_str("accountName"))
        .unwrap()
        .as_string()
        .unwrap();
    assert_eq!(name, "e2e-watch-only");
    
    let xpub_array = Reflect::get(&account_config, &JsValue::from_str("xpubKeys"))
        .unwrap()
        .dyn_into::<Array>()
        .unwrap();
...
async fn test_wasm_bip32watch_account_e2e() {
    ...
    let account_type = Reflect::get(&account_config, &JsValue::from_str("type"))
        .unwrap()
        .as_string()
        .unwrap();
    assert_eq!(account_type, "bip32watch");
    
    let ecdsa = Reflect::get(&account_config, &JsValue::from_str("ecdsa"))
        .unwrap()
        .as_bool()
        .unwrap();
...
fn test_wasm_account_config_serialization() {
    ...
    let xpubs = Array::new();
    xpubs.push(&JsValue::from_str("tpubD6NzVbkrYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQY"));
    Reflect::set(&watch_only_config, &JsValue::from_str("xpubKeys"), &xpubs).unwrap();
    
    // Verify properties
    let name = Reflect::get(&watch_only_config, &JsValue::from_str("accountName"))
        .unwrap()
        .as_string()
        .unwrap();
    assert_eq!(name, "wasm-test-watch-only");
    
    let min_sigs = Reflect::get(&watch_only_config, &JsValue::from_str("minimumSignatures"))
        .unwrap()
        .as_f64()
        .unwrap();
...
fn test_wasm_multisig_config_serialization() {
    ...
    let xpubs = Array::new();
    xpubs.push(&JsValue::from_str("tpubD6NzVbkrYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQY1"));
    xpubs.push(&JsValue::from_str("tpubD6NzVbkrYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQY2"));
    Reflect::set(&multisig_config, &JsValue::from_str("additionalXpubKeys"), &xpubs).unwrap();
    
    // Verify
    let xpub_array = Reflect::get(&multisig_config, &JsValue::from_str("additionalXpubKeys"))
        .unwrap()
        .dyn_into::<Array>()
        .unwrap();
...
async fn test_wasm_multisig_account_e2e() {
    ...
    xpubs.push(&JsValue::from_str("tpubD6NzVbkrYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQY1"));
    xpubs.push(&JsValue::from_str("tpubD6NzVbkrYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQY2"));
    xpubs.push(&JsValue::from_str("tpubD6NzVbkrYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQYhZ4WaWSyoSfhy9D1VbZb8zVwxPqRqkH5P1PQW5EeG9T7VzZQY3"));
    Reflect::set(&multisig_config, &JsValue::from_str("additionalXpubKeys"), &xpubs).unwrap();
    
    // Verify multisig configuration
    let min_sigs = Reflect::get(&multisig_config, &JsValue::from_str("minimumSignatures"))
        .unwrap()
        .as_f64()
        .unwrap();
...
fn test_wasm_account_notification_structure() {
    ...
    let event_type = Reflect::get(&watch_only_event, &JsValue::from_str("type"))
        .unwrap()
        .as_string()
        .unwrap();
    ...
    let account_kind = Reflect::get(&data, &JsValue::from_str("accountKind"))
        .unwrap()
        .as_string()
        .unwrap();
    ...
    let ms_kind = Reflect::get(&ms_data, &JsValue::from_str("accountKind"))
        .unwrap()
        .as_string()
        .unwrap();
...
async fn test_wasm_invalid_account_config() {
    ...
    let xpub_array = Reflect::get(&invalid_config, &JsValue::from_str("xpubKeys"))
        .unwrap()
        .dyn_into::<Array>()
        .unwrap();
