...
//
// #[tokio::test]
// async fn test_cell_subsystem_bootstrap() -> Result<()> {
//     let network_id = NetworkId::with_suffix(NetworkType::Testnet, 10);
//     let rpc_api_mock = Arc::new(RpcCoreMock::new());
//     let processor = CellProcessor::new(Some(rpc_api_mock.clone().into()), Some(network_id), None, None);
//     let _context = CellContext::new(&processor, CellContextBinding::default());
//
...
//
// #[test]
// fn test_cell_generator_empty_cell_noop() -> Result<()> {
//     let network_id = NetworkId::with_suffix(NetworkType::Testnet, 10);
//     let output_address = output_address(network_id.into());
//
//     let payment_output = PaymentOutput::new(output_address, spora_to_sau(2.0));
//     let generator =
