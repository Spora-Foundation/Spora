...
mod tests {
    ...
    fn test_spora_suffix() {
        ...
        assert_eq!(spora_suffix(&NetworkType::Testnet), "TSPORA");
        assert_eq!(spora_suffix(&NetworkType::Simnet), "SSPORA");
        assert_eq!(spora_suffix(&NetworkType::Devnet), "DSPORA");
    }
    ...
    fn test_sau_to_spora_string_with_suffix() {
        ...
        assert_eq!(sau_to_spora_string_with_suffix(50_000_000, &NetworkType::Testnet), "0.5 TSPORA");
        assert_eq!(sau_to_spora_string_with_suffix(200_000_000, &NetworkType::Simnet), "2 SSPORA");
        assert_eq!(sau_to_spora_string_with_suffix(0, &NetworkType::Devnet), "0 DSPORA");

        // Test with larger values
        assert_eq!(sau_to_spora_string_with_suffix(100_000_000_000, &NetworkType::Mainnet), "1,000 SPORA");
        assert_eq!(sau_to_spora_string_with_suffix(12_345_678, &NetworkType::Testnet), "0.12345678 TSPORA");
    }
    ...
    fn test_edge_cases() {
        // Test edge cases
        assert_eq!(sau_to_spora(u64::MAX), u64::MAX as f64 / SAU_PER_SPORA as f64);
