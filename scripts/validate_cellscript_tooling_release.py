...
def main() -> int:
    package_json = json.loads(read("cellscript/editors/vscode-cellscript/package.json"))
    ...
    cargo_toml = read("cellscript/Cargo.toml")
    for excluded in [
        '".github/"',
        '"docs/"',
        '"docs/wiki/"',
